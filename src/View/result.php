...
<div class="container py-5">
    <div class="row">
        <div class="col-12 col-lg-8">
            <h1 class="mb-4 text-dark">📋 <?= htmlspecialchars($translator->translate('result_title')) ?></h1>
            
            <?php if (!empty($result['errors'])): ?>
                <div class="card error-card p-3 rounded mb-4">
            ...
            <?php if (!empty($env)): ?>
                <div class="card p-3 rounded mb-4 bg-light">
                    <h2 class="h5 mb-3">🔍 <?= htmlspecialchars($translator->translate('environment_diagnostics')) ?></h2>
                    <div class="row g-2">
                        <div class="col-md-6">
                            <div class="small">
